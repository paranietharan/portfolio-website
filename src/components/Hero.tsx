...
import profileImage from '../files/profile-img.jpg'
import resume from '../files/Paranietharan_Palasuntharam_SE_Intern_CV.pdf'
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <a
                href={resume}
                download="Paranietharan_Resume.pdf"
                className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center"
              >
