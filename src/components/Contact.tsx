...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'Location',
      value: 'Kilinochchi, Northern Province, Sri Lanka',
      href: null
    }
  ];
            ...
            <div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className={`p-3 bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 text-gray-600 dark:text-gray-400 ${social.color}`}
                    >
                      {social.icon}
                    </a>
                  ))}
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  I'm actively seeking internship and entry-level software developer positions. 
              ...
              <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8">
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
